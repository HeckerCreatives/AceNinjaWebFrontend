...
'use client'
import { bpLinks, ctlLinks, skinsLinks } from '@/app/types/data'
import { a, map } from 'framer-motion/client'
import { Equal, Shirt, ShoppingBag, TicketCheck, X } from 'lucide-react'
                ...
                <div className=' w-full flex items-center justify-between max-w-[1240px] py-2'>
                    ...
                    <div className=' flex items-center gap-4 text-white'>
                        ...
                        <SheetContent className='  flex flex-col items-center'>
                            ...
                            {skinsLinks.map((item, index) => (
                                <a href={item.path} key={index} className=' text-lg font-semibold flex items-center gap-2'><Shirt size={20}/>{item.name}</a>
                            ))}
                            </div>
                            <SheetHeader>
