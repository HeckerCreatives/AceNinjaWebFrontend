    ...
    <div className=' relative w-full h-auto bg-black '>
        ...
        >
            ...
            <div className=' w-full flex flex-col ~gap-6/12 items-center justify-center max-w-[1440px] lg:px-8'>
                <div className=' flex items-center justify-center ~gap-4/12'>
                ...
                <p className=' w-[70%] text-center ~text-xs/lg'>In ACE, your path is your power! Will you embrace the honor of the Samurai, the arcane mastery of the Mage, the wisdom of the Scholar, the cunning of the Rogue, or the shadowy strength of the Dark path? Each path offers unique skills and abilities, letting you build a warrior that matches your playstyle. Choose wisely, forge your destiny, and become a legend in the world of ACE!</p>

                <div className=' w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-12'>
                    <div className=' relative w-full h-auto  flex items-center justify-center max-w-[230px] ' data-aos="fade-right" data-aos-duration={600} data-aos-delay={400}>
                    ...
                    <div className=' relative w-full h-auto flex items-center justify-center max-w-[230px] '  data-aos="fade-right" data-aos-duration={600} data-aos-delay={200}>
                    ...
                    <div className=' relative w-full h-auto flex items-center justify-center max-w-[230px]'  data-aos="fade-up" data-aos-duration={600}>
                    ...
                    <div className=' relative w-full h-auto flex items-center justify-center max-w-[230px]'  data-aos="fade-left" data-aos-duration={600} data-aos-delay={200}>
                    ...
                    <div className=' relative w-full h-auto flex items-center justify-center max-w-[230px]' data-aos="fade-left" data-aos-duration={600} data-aos-delay={400}>
