...
export default function Passes() {
  return (
    <div id='crystals' className=' relative w-full flex flex-col gap-12 items-center justify-center h-auto py-16'>
        ...
        <h2 className=' text-4xl font-black mt-28'>Crystals</h2>
