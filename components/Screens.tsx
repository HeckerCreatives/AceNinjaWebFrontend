...
export default function Screens() {
  ...
  return (
    <div className=' relative z-50 w-full flex flex-col gap-12 items-center justify-center p-6 md:p-12 text-white border-t-4 border-black bg-black'
    ...
    >
        <div className=' w-full max-w-[1440px] pb-48 flex flex-col gap-28 lg:gap-40 items-center border-none'>
            <div className=' w-full grid grid-cols-1 lg:grid-cols-2 ~gap-8/12'>
                ...
                <TiltCard
                    image="/optimize/screens/Phone A.webp"
                    />
                </motion.div>
                ...
                <div className=' w-full flex flex-col gap-8 items-center justify-center' data-aos="fade-up" data-aos-duration={1000} data-aos-delay={300}>
                    ...
                    className=' flex items-center justify-center gap-4'>
                        ...
                        <h2 className=' uppercase text-lg md:text-2xl font-bold text-center'>Challenge other players</h2>
            ...
            <div className=' w-full grid grid-cols-1 lg:grid-cols-2 ~gap-8/12'>
                ...
                <div className=' w-full flex flex-col gap-8 items-center justify-center lg:order-1 order-2'>
                    ...
                    className=' flex items-center justify-center gap-4'>
                        <img src="/optimize/screens/Title side B.webp" alt="" className=' w-6' />
                        <h2 className=' uppercase text-lg md:text-2xl font-bold text-center'>RISE WITH YOUR CLAN ON TOP!</h2>
                        <img src="/optimize/screens/Title side B.webp" alt="" className=' rotate-180 w-6' />
                    </motion.div>
                ...
                <TiltCard
                    image="/optimize/screens/Phone B.webp"
                    />
                </motion.div>
            ...
            <motion.div className=' w-full'
                ...
                <TiltCard
                    image="/optimize/screens/Phone C.webp"
                    />
                </motion.div>
