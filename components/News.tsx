  ...
  return (
    ...
    >
        ...
        >
            ...
            <Image
            src={`/optimize/download/Scroll TAB Horizontal.webp`}
            alt={'tab'}
            width={365}            
            height={205}
                ...
                {list.length !== 0 ? (
                 <>
                            ...
                            <div key={item.id} className="w-[365px] h-full  border-4 border-amber-900 bg-white rounded-sm p-[.1rem]">
                                <div className="w-full min-h-[100%] h-full flex flex-col border-[1px] border-amber-500 p-2">
                                    {item.type === "image" ? (
                                        ...
                                        >
                                            <Image src={`${process.env.NEXT_PUBLIC_API_URL}/${item.url}`} alt="img" loading='lazy' width={300} height={120} className=' w-full aspect-video' />
                                        </div>
                                    ) : (
                                    ...
                                    <div className="w-full h-full p-4 flex flex-col gap-4">
                                        ...
                                        <DialogContent className=' overflow-y-auto max-h-[70vh] touch-none'>
                                            ...
                                            <div className=' flex flex-col gap-4'>
                                                <h2 className=" text-start ~text-sm/lg font-bold text-white underline">{item.title}</h2>
                                                <p className="  ~text-xs/sm text-start whitespace-pre-wrap">{item.content}</p>
                                            </div>
                                        </DialogContent>
                                        </Dialog>

                                        <p className="  ~text-xs/sm text-start line-clamp-3 xl:line-clamp-4 text-amber-950">{item.content}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className=' flex items-center justify-center w-full h-full '>
                        <p className=' text-black'>No news yet.</p>
                    </div>
                )}
                            ...
                            <div key={item.id} className="max-w-[365px] w-full min-h-[355px]  border-4 border-amber-900 bg-white rounded-sm p-[.1rem]">
                                <div className="w-full h-full flex flex-col border-[1px] min-h-[355px] border-amber-500 p-2">
                                    ...
                                    <div className="w-full h-full p-4 flex flex-col items-center justify-center gap-4">
                                        ...
                                        <p className="  ~text-xs/sm text-center line-clamp-3 xl:line-clamp-6 text-amber-950">{item.content}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
